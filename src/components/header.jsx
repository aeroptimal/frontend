        ...
        <header className="c-header">
            <nav className="c-nav">
                ...
                <ul className="c-nav__menu">
                    <li className="c-nav__item"><a href="#about"><Link to="about" smooth={true}>About Us</Link></a> </li>
                    <li className="c-nav__item"><a href="#modules"><Link to="modules" smooth={true}>Modules</Link></a> </li>
